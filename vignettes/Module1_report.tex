...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Downloading GitHub repo EllaKaye/Module1@master\\\#\# Installing Bootstrap\\\#\# '/Library/Frameworks/R.framework/Resources/bin/R' --no-site-file\ \ \textbackslash{}\\\#\#\ \  --no-environ --no-save --no-restore CMD INSTALL\ \ \textbackslash{}\\\#\#\ \  '/private/var/folders/\_x/1hzfr9yd55x1r0zylyswcxd00000gn/T/Rtmp3qifSs/devtools58c21e94a6f3/EllaKaye-Module1-b16378d'\ \ \textbackslash{}\\\#\#\ \  --library='/Library/Frameworks/R.framework/Versions/3.2/Resources/library'\ \ \textbackslash{}\\\#\#\ \  --install-tests}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: Command failed (1)}}\end{kframe}
\end{knitrout}
and loaded.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
...
\hlkwd{BLB.multi}\hlstd{(data,} \hlkwc{gamma}\hlstd{=}\hlnum{0.7}\hlstd{,} \hlkwc{s}\hlstd{=}\hlnum{15}\hlstd{,} \hlkwc{r}\hlstd{=}\hlnum{100}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}BLB.multi"{}}}\end{kframe}
\end{knitrout}
